    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="#" class="brand-link logo-switch" style="display: flex; align-items: center;">
                ...
                <!-- Audit Trail -->
                <li class="nav-item">
                    <a href="{{ route('admin.audit_trail.index') }}" class="nav-link {{ Request::routeIs('admin.audit_trail.index') ? 'active' : '' }}">
